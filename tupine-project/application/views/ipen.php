    ...
    <section>
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <div class="card">
                        <img src="<?php echo base_url('./assets/I-Pen.jpeg') ?>" class="card-img-top" alt="Card image">
                        <div class="card-body">
                                    ...
                                    <div id="collapseOne" class="accordion-collapse collapse show"
                                        ...
                                        <div class="accordion-body">
                                            <strong>หลักสูตรวิศวกรรมศาสตรบัณฑิต
                                                ...
                                                &nbsp; -  จุดเด่นมุ่งเน้นในการพัฒนาบุคลากรด้านวิศวกรรมไฟฟ้าแบบบูรณาการ ร่วมกับองค์ความรู้ในด้านวิศวกรรมอุตสาหการควบคู่กัน<br>
                                                &nbsp; -  เนื้อหาโดยรวม เนื้อหาหลักสูตรจะมุ่งเน้นให้นักศึกษาได้เรียนรู้และเข้าใจในระบบไฟฟ้า
                                                ระบบอิเล็กทรอนิกส์ กระบวนการและระบบควบคุมในโรงงานอุตสาหกรรม และมีความเข้าใจถึงระบบการผลิต การปรับปรุงประสิทธิภาพและการบริหารจัดการอุตสาหกรรมเข้าด้วยกัน
